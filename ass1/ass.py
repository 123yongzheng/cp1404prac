...
Travel Tracker 1.0
Student Name: Zhang Haolun
Date started: 27/4/2023
"""
import csv
import random
...
def loadFile():
    with open(FILENAME) as file:
        ...
        # Use list comprehension to create list of rows
...
def mark_place(places):
    # Check if there are any unvisited places
    unvisited_count = count_unvisited(places)
    if unvisited_count == 0:
        print("You have visited all the places!")
        return

    # Print the list of places and ask for user input
    list_places(places)
    while True:
    ...
    # Check if the selected place has already been visited
...
def main():
    print("Travel Tracker 1.0 - by Zhang Haolun")
